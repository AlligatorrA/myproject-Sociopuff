        ...
        <div className="main-header fixed-top wow fadeIn" data-wow-delay=".3s">
          <div className="container d-flex align-items-center">
            <div className="logo-header">
              ...
              <button
                className="navbar-toggler topbar-toggler more toggled ml-auto"
                type="button"
              >
            ...
            <nav className="navbar navbar-header navbar-expand-lg ml-auto">
            ...
            {
              token ? <Link className="login ml-auto" to="/login">
                Login
              </Link> : <button className="btn" onClick={LogOutHandle}>logout</button>
            }
            <Link className="login ml-auto" to="/login">
              Login
            </Link>
            <Link className="signup btn" to="/Createaccount">
              Sign up
            </Link>
          </div>
        </div>
